{
    "experiment": {
        ...
        "agent_config": {
            ...
            # "buffer_size": 110000,  # Needs to be > than total_timesteps below
            # "learning_rate": 0.01,
            # "tau": 0.01,
            # "gamma": 0.99,
            # "train_freq": 200,
        ...
        # "agent_train_config": {"total_timesteps": 100000, "log_interval": 10},  # SAC
        # "agent_train_config": {"total_timesteps": 2000, "log_interval": 10},  # SAC SMALL
        "agent_train_config": {"total_timesteps": 1000000, "log_interval": 500},  # PPO
        "callback_configs": [
            {
                "name": "rollout_buffer",
                "agent": True,
